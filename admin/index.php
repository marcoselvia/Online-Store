              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="elvias/elvia.jpg" style="width:35px;height:35px;" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="box box-success">
            ...
            <div class="box-body chat" id="chat-box">
              ...
              <div class="item">
                ...
                <p class="message">
                  ...
                  Me gustaría conocerte para discutir las últimas noticias sobre
                    La llegada del nuevo tema. Dicen que va a ser uno de los
                    mejores temas en el mercado
                </p>
              ...
              <!-- chat item -->
              <div class="item">
                <img src="elvias/elvia.jpg" style="width:35px;height:35px;" alt="user image" class="offline">
s
                <p class="message">
                  <a href="#" class="name">
        ...
        <section class="col-lg-5 connectedSortable">
          ...
          <!-- /.box -->
  <!--desde aqui inicia el calendario-->
          <!-- Calendar -->
