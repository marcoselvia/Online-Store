...
(1, 1000, 'combo.png', 'COMBO', 3, 0, ''),
(2, 200, 'maquina.png', 'MAQUINA', 3, 0, ''),
(4, 1000, 'plancha.png', 'PLANCHA', 3, 50, ''),
(5, 400, 'Telefono.png', 'TELEFONO', 3, 10, ''),
(7, 1000, 'televisor.png', 'TELEVISION', 0, 0, '215secreto del mundo.txt');
